...
#Pruning
##plink --bfile QCP.$BIN --indep-pairwise 50 5 0.5 --out Pruning

##plink --bfile QCP.$BIN --extract Pruning.prune.in --make-bed --out Pruned.$BIN
...
./plink --bfile $file.QCed --keep-allele-order --freq --missing --within $clust --recode --out $file.stats --threads 30
