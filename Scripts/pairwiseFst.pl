...
#chdir "/picb/humpopg6/denglian/Malay/Data";
...
#			$out2 = $1;
#		}
#		my $fst_out = "/picb/humpopg6/denglian/Negrito_Pygmy/FST/$out1"."-".$out2.".fst";
...
#				}
		...
		# 		print OUT "$rsid_1\t$a0_1\t$a1_1\t$chr\t$pos\t$fst_nume\t$fst_deno\t$fst\n";
