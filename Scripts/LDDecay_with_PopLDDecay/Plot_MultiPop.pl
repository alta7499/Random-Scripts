...
plot(E$PopName\[,1\]/1000,E$PopName\[,2\],type="l",col="$ColArry[0]",main="LD decay",xlab="Distance(Kb)",xlim=c(0,$maxX),ylim=c(0,$maxY_tmp),ylab=expression(r^{2}),bty="n",lwd=2)
LOVE
	...
	for (my $IDE=1; $IDE<= $PopNumber; $IDE++)
	{
		...
		$Plot.=<<LOVE;
read.table("$output.$PopName")->E$PopName;
lines(E$PopName\[,1\]/1000,E$PopName\[,2\],col="$ColArry[$IDE]",lwd=2)
LOVE
...
pdf("$output.pdf")
$Plot
legend("topright",c($legendName),col=c($legendCol),cex=1,lty=c($legendlty),bty="n",lwd=2);
dev.off()
png("$output.png")
$Plot
legend("topright",c($legendName),col=c($legendCol),cex=1,lty=c($legendlty),bty="n",lwd=2);
...
if ( $RowPlot==3 )
{
	...
	$Plot=<<LOVE;
read.table("$output.$PopName")->E$PopName;
plot(E$PopName\[,1\]/1000,E$PopName\[,3\],type="l",col="$ColArry[0]",main="LD decay",xlab="Distance(Kb)",xlim=c(0,$maxX),ylim=c(0,1.0),ylab="D'",bty="n",lwd=2)
LOVE
	...
	for (my $IDE=1; $IDE<= $PopNumber; $IDE++)
	{
		...
		$Plot.=<<LOVE;
read.table("$output.$PopName")->E$PopName;
lines(E$PopName\[,1\]/1000,E$PopName\[,3\],col="$ColArry[$IDE]",lwd=2)
LOVE
	}
...
HEWM
	...
	elsif ( $RowPlot==4 )
	{
		...
		my $Plot2=<<LOVE;
read.table("$output.$PopName")->E$PopName;
plot(E$PopName\[,1\]/1000,E$PopName\[,3\],type="l",col="$ColArry[0]",xlab="",xlim=c(0,$maxX),ylim=c(0,1.0),ylab="",bty="n",lty=2,yaxt="n",lwd=2)
...
LOVE
		...
		for (my $IDE=1; $IDE<= $PopNumber; $IDE++)
		{
			...
			$Plot2.=<<LOVE;
read.table("$output.$PopName")->E$PopName;
lines(E$PopName\[,1\]/1000,E$PopName\[,3\],col="$ColArry[$IDE]", lty=2,lwd=2)
LOVE
		}
...
plot(E$PopName\[,1\]/1000,E$PopName\[,2\],type="l",col="$ColArry[0]",main="LD decay $method ($percent) ",xlab="Distance(Kb)",xlim=c(0,$maxX),ylim=c(0,1),ylab=expression(r^{2}),bty="n",lwd=2)
LOVE
...
LOVE
	...
	plot(E$PopName\[,1\]/1000,E$PopName\[,2\],type="l",col="$ColArry[0]",main="LD decay $method ($percent) ",xlab="Distance(Kb)",xlim=c(0,$maxX),ylim=c(0,1.0),ylab="D'",bty="n",lwd=2)
LOVE
		my $Plot3="";
		for (my $IDE=1; $IDE<= $PopNumber; $IDE++)
		{
...
HEWM
		...
		elsif ($RowPlot==4)
		{
			...
			$Plot2=<<LOVE;
	read.table("$output.$PopName.ddtmp")->E$PopName;
	plot(E$PopName\[,1\]/1000,E$PopName\[,2\],type="l",col="$ColArry[0]",xlab="",xlim=c(0,$maxX),ylim=c(0,1.0),ylab="",bty="n",yaxt="n",lty=2,lwd=2)
	axis(4,col="red",col.ticks="red",col.axis="red",lty=2)
	mtext("D'",side=4,line=-1,col="red")
LOVE
...
plot(newfile$PopName\$dist/1000, newfile$PopName\$rsq, type="l",col="$ColArry[0]",main="LD decay", xlab="Distance (Kb)", ylab=expression(r^{2}),bty="n",xlim=c(0,$maxX),lwd=2)
...
newfile <- newfile[order(newfile\$file.dist),]
newfile$PopName  <- base::unique(newfile)
lines(newfile$PopName\$dist/1000, newfile$PopName\$rsq, type="l",col="$ColArry[$IDE]",main="LD decay", xlab="Distance (Kb)", ylab=expression(r^{2}),bty="n",xlim=c(0,$maxX),lwd=2)
...
LOVE
		...
		{
			$Plot2.=<<LOVE;
	plot(newfile$PopName\$dist/1000, newfile$PopName\$rsq, type="l",col="$ColArry[0]",main="LD decay", xlab="Distance (Kb)", ylab="D'",bty="n",xlim=c(0,$maxX),lwd=2)
LOVE
		}
		elsif ($RowPlot==4)
		{
			$Plot2.=<<LOVE;
	plot(newfile$PopName\$dist/1000, newfile$PopName\$rsq, type="l",col="$ColArry[0]", xlab="", ylab="",bty="n",xlim=c(0,$maxX),yaxt="n",lty=2,lwd=2)
	axis(4,col="red",col.ticks="red",col.axis="red",lty=2)
	mtext("D'",side=4,line=-1,col="red") 
LOVE
		}
